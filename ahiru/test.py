...
class BookT(unittest.TestCase):
	...
	def test_putAction(self):
		taro = User('taro', 'abcde', '123456')
		book = Book.create(taro, 'testBook', '.')
		action = Action.new(bookID = book.getID(), user = taro, no = 1, act = Action.Insert, data = 'hoge')
		...
		action2 = Action.new(bookID = book.getID(), user = taro, no = 2, act = Action.Update, data = 'fuga', parent = a)
...
class QuackT(unittest.TestCase):
	...
	'''
	def test_2members_put_tuple(self):
		taro = User('taro', 'abc', '123', '127.0.0.1', 2016)
		ahiru = Ahiru(user = taro)
		bookID = ahiru.create('test book')
		ahiru.quack()
		time.sleep(0.2)
		hanako = User('hanako', 'hhh', 'ggg', '127.0.0.1', 2017)
		ahiru.addMember(bookID, hanako )
		ahiruH = Ahiru(user = hanako)
		ahiruH.join(bookID, '127.0.0.1', 2016)
		time.sleep(0.2)
		ahiruH.quack()
		actionID = ahiru.put(bookID, (1, 2, 3))
		time.sleep(0.2)
		ahiru.stop()
		ahiruH.stop()
	...
	def test_2members_put_list(self):
		taro = User('taro', 'abc', '123', '127.0.0.1', 2018)
		ahiru = Ahiru(user = taro)
		bookID = ahiru.create('test book')
		ahiru.quack()
		time.sleep(0.2)
		hanako = User('hanako', 'hhh', 'ggg', '127.0.0.1', 2019)
		ahiru.addMember(bookID, hanako )
		ahiruH = Ahiru(user = hanako)
		ahiruH.join(bookID, '127.0.0.1', 2018)
		time.sleep(0.2)
		ahiruH.quack()
		actionID = ahiru.put(bookID, [9, 8, 7])
		time.sleep(0.2)
		ahiru.stop()
		ahiruH.stop()
	...
	def test_2members_put_dict(self):
		taro = User('taro', 'abc', '123', '127.0.0.1', 2020)
		ahiru = Ahiru(user = taro)
		bookID = ahiru.create('test book')
		ahiru.quack()
		time.sleep(0.2)
		hanako = User('hanako', 'hhh', 'ggg', '127.0.0.1', 2021)
		ahiru.addMember(bookID, hanako )
		ahiruH = Ahiru(user = hanako)
		ahiruH.join(bookID, '127.0.0.1', 2020)
		time.sleep(0.2)
		ahiruH.quack()
		actionID = ahiru.put(bookID, {'a':'z'})
		time.sleep(0.2)
		ahiru.stop()
		ahiruH.stop()
